 ...
 * FIFO COUNT
 *
 * This is the number of entries currently visible from the
 * READ-clock domain.
 *
 * The synchronized write pointer may lag the actual write
 * pointer by CDC latency. That is expected.
 * ============================================================ */

assign fifo_count = sync_w_ptr - r_ptr;
