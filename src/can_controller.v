module can_controller #(
    ...
    wire rx_frame_valid_int;
    wire rx_frame_write_event;
    ...
    /* =============================================================
     * RX FRAME WRITE EVENT
     * ============================================================= */

    /*
     * Generate exactly one write pulse at the final EOF bit.
     *
     * The registered rx_frame_valid generated by the RX datapath
     * must not be used directly for the FIFO write because it would
     * result in a duplicate FIFO entry.
     */

    assign rx_frame_write_event =
        bit_en &&
        (field_sel == EOF) &&
        (bit_cnt == 6'd1);

    assign rx_frame_valid = rx_frame_write_event;
